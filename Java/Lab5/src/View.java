...
public class View implements Initializable {
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        ...
        if (source == undo) {
            ...
            try {
                ...
                warningDialog(resources.getString("noConnection"));
            }
    ...
    private void downloadFile() {
        if (controller.onClose(false)) {
            String filename = stringDialog(resources.getString("filename"));
            if (filename != null) {
                showWait();
    ...
    public String stringDialog(String text) {
