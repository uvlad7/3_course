...
import sample.config.ServerConnection;
...
public class Controller implements Initializable {
    ...
    public void setProperties(Properties properties) throws SQLException {
        connection = ServerConnection.getInstance(properties).dataConnection;
        updateVocabularies();
    }
    ...
    abstract class DBTask<T> extends Task<T> {
        DBTask() {
            setOnFailed(t -> alert(Alert.AlertType.ERROR, getException().getMessage()));
