...
import app.entity.RecordList;
import app.entity.Vocabulary;
import app.entity.VocabularyList;
...
public interface DataConnection {
    ...
    VocabularyList getVocabularies() throws SQLException;

    RecordList selectVocabulary(int id, boolean isExplanatory) throws SQLException;

    RecordList findAllLikeStr(String subStr) throws SQLException;
