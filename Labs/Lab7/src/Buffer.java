...
public class Buffer {
    ...
    public static Object readObject(RandomAccessFile file, long position, SimpleBooleanProperty wasZipped) throws IOException, ClassNotFoundException {
        file.seek(position);
